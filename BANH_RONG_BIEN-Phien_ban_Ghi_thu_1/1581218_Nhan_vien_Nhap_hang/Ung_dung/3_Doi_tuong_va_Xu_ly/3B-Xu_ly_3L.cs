...
//==================== Khởi động ==============
    ...
    public string Ghi_Nhap_hang_Moi(string Ma_so_San_pham, int So_luong)
    {
        ...
        if (Hop_le)
        {
            ...
            var Kq_Ghi = XL_LUU_TRU.Ghi_Nhap_hang_Moi(San_pham, Nhap_hang);
            if (Kq_Ghi == "OK")
    ...
    public string Tao_Chuoi_HTML_Ket_qua()
    {
        ...
        var Chuoi_HTML = $"<div>" +
                 $"{XL_THE_HIEN.Tao_Chuoi_HTML_Thong_tin_nguoi_dung(Nguoi_dung_Dang_nhap)}" +
...
{    
    ...
    public static List<XmlElement> Tao_Danh_sach_San_pham_cua_Nguoi_dung(
            XmlElement Nguoi_dung, XmlElement Danh_sach_Tat_ca_San_pham)
    {
        var Danh_sach = new List<XmlElement>();
        var DS_Tat_ca_San_pham = Tao_Danh_sach(Danh_sach_Tat_ca_San_pham, "San_pham");
        Danh_sach = DS_Tat_ca_San_pham.FindAll(
...
public partial class XL_LUU_TRU
{
    ...
    public static string Ghi_Nhap_hang_Moi(XmlElement San_pham, XmlElement Nhap_hang)
    {
        ...
        try
        {
            var Xu_ly = new WebClient();
            Xu_ly.Encoding = System.Text.Encoding.UTF8;
            var Tham_so = $"Ma_so_Xu_ly=GHI_NHAP_HANG_MOI&Ma_so_San_pham={San_pham.GetAttribute("Ma_so")}";
            var Dia_chi_Xu_ly = $"{Dia_chi_Dich_vu_Du_lieu}?{Tham_so}";
