...
public class XL_NGUOI_DUNG_DANG_NHAP
{
    ...
    public List<XmlElement> Danh_sach_Phieu_dat_Chua_Phan_cong = new List<XmlElement>();
    public List<XmlElement> Danh_sach_Phieu_dat_Da_Phan_cong = new List<XmlElement>();
